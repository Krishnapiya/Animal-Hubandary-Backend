...
import com.keltron.petshop.services.impl.ApplicationWorkflowServiceImpl;
...
import com.keltron.utility.jpa.predicates.ApplicationWorkflowPredicates;
...
@RestController
@RequestMapping("petshop/auth/application-workflow")
public class ApplicationWorkflowController
        extends AbstractController {

    @Autowired
    private ApplicationWorkflowServiceImpl serviceImpl;

    @PostMapping("/save")
    public ResponseEntity<AbstractResponse> save(
            @Valid @RequestBody Request<ApplicationWorkflowDto> request) {
    ...
    public ResponseEntity<AbstractResponse> findByCriteria(
            @Valid ApplicationWorkflowSearchBean searchBean) {
