...
public final class PetShopApplicationDocumentPredicates {

    private PetShopApplicationDocumentPredicates() {
    }

    public static Specification<PetShopApplicationDocument> createPredicate(
            PetShopApplicationDocumentSearchBean searchBean) {
