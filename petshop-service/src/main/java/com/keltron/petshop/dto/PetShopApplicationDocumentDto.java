...
@Getter
@Setter
public class PetShopApplicationDocumentDto extends AbstractDto {
    ...
    @Override
    public PetShopApplicationDocument toEntity() {

        PetShopApplicationDocument entity =
                new PetShopApplicationDocument();
