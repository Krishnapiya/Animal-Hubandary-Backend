...
@NoArgsConstructor
@ToString
public class PetShopRegistrationApplication extends AbstractEntity {
    ...
    public <K extends AbstractDto> void copyFromDTO(K dto) {
        ...
        PetShopRegistrationApplicationDto appDto =
...
//        this.cvOfficeId = appDto.getCvOfficeId();
    ...
    @Override
    public PetShopRegistrationApplicationDto toDTO() {

        PetShopRegistrationApplicationDto dto =
                new PetShopRegistrationApplicationDto();
    ...
    public PetShopRegistrationApplication(Long id) {
        this.id = id;
    }
}