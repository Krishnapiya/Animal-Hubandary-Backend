...
import com.keltron.dogbreeder.services.impl.DogBreederRegistrationInspectionServiceImpl;
...
@RestController
@RequestMapping("dogbreeder/auth/registration-inspection")
public class DogBreederRegistrationInspectionController extends AbstractController {

    @Autowired
    private DogBreederRegistrationInspectionServiceImpl serviceImpl;
    ...
    public ResponseEntity<AbstractResponse> save(
            @Valid @RequestBody Request<DogBreederRegistrationInspectionDto> request) {
