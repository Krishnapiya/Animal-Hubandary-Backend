...
@Entity
@Table(
        name = "dogbreeder_registration_application_resubmission",schema = "awb")

public class DogBreederRegistrationApplicationResubmission extends AbstractEntity {
    ...
    public DogBreederRegistrationApplicationResubmission(Long id) {
        this.id = id;
    }
    ...
    public <K extends AbstractDto> void copyFromDTO(K dto) {
        ...
        DogBreederRegistrationApplicationResubmissionDto resubmissionDto =
        ...
        if (ValidationUtils.isValid(resubmissionDto.getApplicationId())) {
            this.application =
        ...
        this.resubmittedAt = resubmissionDto.getResubmittedAt();
        this.resubmittedBy = resubmissionDto.getResubmittedBy();
    }

    @SuppressWarnings("unchecked")
	@Override
    public DogBreederRegistrationApplicationResubmissionDto toDTO() {

        DogBreederRegistrationApplicationResubmissionDto dto =
                new DogBreederRegistrationApplicationResubmissionDto();
    ...
    public DropdownPayload<Long> toDropDownPayload() {
        ...
        payload.setId(id);
        payload.setName("Dog Breeder Resubmission " + id);
