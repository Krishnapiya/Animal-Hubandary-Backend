...
public class DogBreederRegistrationApplicationDto extends AbstractDto{
	 ...
	 private static final long serialVersionUID = 1L;
		...
		@Override
	    public DogBreederRegistrationApplication toEntity() {

	    	DogBreederRegistrationApplication entity =
