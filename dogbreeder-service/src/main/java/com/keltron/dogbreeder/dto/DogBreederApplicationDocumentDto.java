...
@Getter
@Setter
public class DogBreederApplicationDocumentDto extends AbstractDto{
	 ...
	 private static final long serialVersionUID = 1L;
	    ...
	    @Override
	    public DogBreederApplicationDocument toEntity() {

	    	DogBreederApplicationDocument entity = new DogBreederApplicationDocument();
	        ...
	        if (ValidationUtils.isValid(id)) {
	         ...
	         if (ValidationUtils.isValid(applicationId))
	             entity.setApplication(new DogBreederRegistrationApplication(applicationId));
