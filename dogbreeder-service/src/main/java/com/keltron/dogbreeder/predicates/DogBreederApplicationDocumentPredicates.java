...
public class DogBreederApplicationDocumentPredicates {
	 public static Specification<DogBreederApplicationDocument> createPredicate(
			 DogBreederApplicationDocumentSearchBean searchBean) {
