...
import com.keltron.admin.services.impl.PaymentStatusMasterServiceImpl;
...
import com.keltron.utility.jpa.predicates.PaymentStatusMasterPredicates;
...
@RestController
@RequestMapping(value = "admin/auth/master/payment-status-master")
@PreAuthorize("hasRole('ADMIN')")
public class PaymentStatusMasterController extends AbstractController {

    @Autowired
    private PaymentStatusMasterServiceImpl serviceImpl;

    @PostMapping("/save")
    public ResponseEntity<AbstractResponse> save(
            @Valid @RequestBody Request<PaymentStatusMasterDto> request) {
    ...
    public ResponseEntity<AbstractResponse> findByCriteria(
            ...
            @Valid PaymentStatusMasterSearchBean searchBean) {

        return asDropdown
                ? new ResponseBuilder()
                        .withData(
                            serviceImpl.findByCriteria(
                            		PaymentStatusMasterPredicates
