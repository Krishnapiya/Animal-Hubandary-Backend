...
import com.keltron.admin.services.impl.RegistrationApplicationServiceImpl;
...
import com.keltron.utility.jpa.predicates.RegistrationApplicationPredicates;
...
@RestController
@RequestMapping(value = "admin/auth/registration-application")
@PreAuthorize("hasRole('ADMIN')")
public class RegistrationApplicationController
        extends AbstractController {

    @Autowired
    private RegistrationApplicationServiceImpl serviceImpl;
...
//    }
    ...
    public ResponseEntity<AbstractResponse> findByCriteria(
            ...
            @Valid RegistrationApplicationSearchBean searchBean) {

        return asDropdown
                ? new ResponseBuilder()
                        .withData(
                                serviceImpl.findByCriteria(
                                        RegistrationApplicationPredicates
