...
import com.keltron.admin.services.impl.SampleDepartmentServiceImpl;
...
import com.keltron.utility.jpa.predicates.SampleDepartmentPredicates;
...
@RestController
@RequestMapping(value = "admin/auth/master/sample-department")
public class SampleDepartmentController extends AbstractController {

    @Autowired
    private SampleDepartmentServiceImpl serviceImpl;

    @PostMapping("/save")
    @RequirePermission(menu = "sample-department", action = "save")
    public ResponseEntity<AbstractResponse> save(@Valid @RequestBody Request<SampleDepartmentDto> request) {
    ...
    @PatchMapping("/save")
    @RequirePermission(menu = "sample-department", action = "edit")
    public ResponseEntity<AbstractResponse> update(@Valid @RequestBody Request<SampleDepartmentDto> request) {
    ...
    @GetMapping("/list/all")
    @RequirePermission(menu = "sample-department", action = "list")
    public ResponseEntity<AbstractResponse> findByCriteria(
        ...
        @Valid SampleDepartmentSearchBean searchBean) {
        return asDropdown
            ? new ResponseBuilder()
                .withData(serviceImpl.findByCriteria(
                    SampleDepartmentPredicates.createPredicate(searchBean),
    ...
    @RequirePermission(menu = "sample-department", action = "delete")
    ...
    @RequirePermission(menu = "sample-department", action = "export")
    public ResponseEntity<ByteArrayResource> downloadExcel(@RequestBody ExcelExportRequest request) {
        ...
        return ResponseEntity.ok()
            .header(HttpHeaders.CONTENT_DISPOSITION, "attachment; filename=sample-department.xlsx")
