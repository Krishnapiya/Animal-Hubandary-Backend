...
import com.keltron.admin.services.impl.ApplicationStatusMasterServiceImpl;
import com.keltron.utility.ResponseBuilder;
import com.keltron.utility.beans.dto.ApplicationStatusMasterDto;
import com.keltron.utility.beans.searchbean.ApplicationStatusMasterSearchBean;
import com.keltron.utility.jpa.predicates.ApplicationStatusMasterPredicates;
...
@RestController
@RequestMapping(value = "admin/auth/master/application-status-master")
@PreAuthorize("hasRole('ADMIN')")
public class ApplicationStatusMasterController extends AbstractController {

    @Autowired
    private ApplicationStatusMasterServiceImpl serviceImpl;

    @PostMapping("/save")
    public ResponseEntity<AbstractResponse> save(
            @Valid @RequestBody Request<ApplicationStatusMasterDto> request) {
    ...
    public ResponseEntity<AbstractResponse> findByCriteria(
            ...
            @Valid ApplicationStatusMasterSearchBean searchBean) {

        return asDropdown
                ? new ResponseBuilder()
                        .withData(
                            serviceImpl.findByCriteria(
                                ApplicationStatusMasterPredicates
