...
public class ApplicationStatusMasterPredicates {

    public static Specification<ApplicationStatusMaster> createPredicate(
            ApplicationStatusMasterSearchBean searchBean) {
