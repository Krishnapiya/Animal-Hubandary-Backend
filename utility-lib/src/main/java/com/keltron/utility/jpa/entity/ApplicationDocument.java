...
//
//        ApplicationDocumentDto documentDto = (ApplicationDocumentDto) dto;
//
//        if (ValidationUtils.isValid(documentDto.getId()))
//            id = documentDto.getId();
//
//       if (ValidationUtils.isValid(documentDto.getApplicationId()))
//            application = new RegistrationApplication(documentDto.getApplicationId());
//
...
//    @Override
//    public ApplicationDocumentDto toDTO() {
//
...
//    }
//
//    public ApplicationDocument(Long id) {
//        this.id = id;
//    }
//}