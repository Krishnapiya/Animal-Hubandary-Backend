...
@Getter
@Setter
@Table(name = "application_status_master", schema = "awb")
@Entity
@ToString
@NoArgsConstructor
public class ApplicationStatusMaster extends AbstractEntity {
    ...
    public <K extends AbstractDto> void copyFromDTO(K dto) {
        ApplicationStatusMasterDto statusDto = (ApplicationStatusMasterDto) dto;
    ...
    @Override
    public ApplicationStatusMasterDto toDTO() {
        ApplicationStatusMasterDto dto = new ApplicationStatusMasterDto();
